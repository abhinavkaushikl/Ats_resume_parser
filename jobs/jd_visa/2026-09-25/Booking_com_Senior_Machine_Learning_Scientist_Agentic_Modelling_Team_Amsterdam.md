# Senior Machine Learning Scientist - Agentic Modelling Team

- **Company:** Booking.com
- **City:** Amsterdam
- **Visa / relocation:** yes
- **Original listing:** https://nl.linkedin.com/jobs/view/senior-machine-learning-scientist-agentic-modelling-team-at-booking-com-4435122980
- **JD source (LinkedIn public page):** https://nl.linkedin.com/jobs/view/senior-machine-learning-scientist-agentic-modelling-team-at-booking-com-4435122980
- **Fetched:** 2026-09-25 23:05



- **Resume match:** 90% - shortlisted: The candidate’s resume demonstrates extensive, production‑scale work on LLM‑based agents, LangGraph, RAG and evaluation, matching the core requirements, with only minor nice‑to‑have gaps.
- **Matched:** Advanced NLP/LLM experience; Agentic AI architectures (LangGraph, tool orchestration, RAG); Production-grade agentic/conversational AI systems; LLM evaluation and optimization pipelines; MSc in Machine Learning/AI with 8+ years experience; Strong Python and ML/AI frameworks; Cross‑functional collaboration
- **Missing:** Peer‑reviewed publications/patents/open‑source contributions (nice‑to‑have)
...
**About the team:**This opening is for the **Agentic Modeling Team** within the Data & AI Marketplace department.
