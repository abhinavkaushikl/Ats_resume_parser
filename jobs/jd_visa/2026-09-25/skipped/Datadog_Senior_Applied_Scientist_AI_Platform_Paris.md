...
- **Company:** Datadog
- **City:** Paris
- **Visa / relocation:** Visa: yes (French Tech Visa) · Relocation: yes (negotiated) · Source: [Worktugal](https://blog.worktugal.com/datadog-hiring-paris-2026/) · ⚠️ weak source, confirm with recruiter
- **Original listing:** https://fr.linkedin.com/jobs/view/senior-applied-scientist-ai-platform-at-datadog-4462477905
- **JD source (Playwright):** https://careers.datadoghq.com/detail/8172855/


- **Resume match:** 48% - skipped: Candidate's LLM evaluation and production engineering work is relevant, but the role's core requirement - hands-on post-training data creation with PhD-level research ownership - is not shown in the resume.
- **Matched:** MS in Machine Learning/AI; 8+ years applied ML/AI engineering; LLM/agent evaluation pipelines and quality metrics; LangGraph multi-agent and RAG systems; Production ML engineering (Docker, K8s, MLflow); Strong Python
- **Missing:** PhD or equivalent deep research background; Hands-on LLM/agent post-training data creation (the most heavily weighted requirement); Setting technical research direction for a team; Distributed training/GPU infrastructure experience
