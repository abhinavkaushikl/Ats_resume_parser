...
- **City:** London
- **Visa / relocation:** yes
- **Original listing:** https://uk.linkedin.com/jobs/view/applied-scientist-ads-brand-safety-and-suitability-at-amazon-science-4471440704
- **JD source (LinkedIn public page):** https://uk.linkedin.com/jobs/view/applied-scientist-ads-brand-safety-and-suitability-at-amazon-science-4471440704
- **Fetched:** 2026-09-25 23:07


- **Resume match:** 38% - skipped: Missing required patents/publications despite strong relevant experience lowers fit significantly
- **Matched:** Master's degree in ML/AI; Python programming; Experience with algorithms/data structures, parsing, distributed computing (Spark, PySpark); Built ML models for business applications
- **Missing:** Patents or peer‑reviewed publications
- **Blockers:** No evidence of patents or top‑tier peer‑reviewed publications, a stated basic qualification

## Job description

**Description**Amazon Ads Brand Safety & Suitability protects advertisers from exposure to unsafe, unsuitable, or policy-violating content across web, mobile app, CTV, and audio advertising inventory. Our mission is to ensure that every ad impression delivered through Amazon's demand-side platform appears adjacent to content that meets advertiser trust expectations while giving brands granular controls to define suitability on their own terms. We operate at the intersection of advertiser trust, publisher quality, and supply integrity.
