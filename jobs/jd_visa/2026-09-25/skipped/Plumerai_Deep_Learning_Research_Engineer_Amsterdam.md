...
- **City:** Amsterdam
- **Visa / relocation:** yes
- **Original listing:** https://nl.linkedin.com/jobs/view/deep-learning-research-engineer-at-plumerai-4451566225
- **JD source (LinkedIn public page):** https://nl.linkedin.com/jobs/view/deep-learning-research-engineer-at-plumerai-4451566225
- **Fetched:** 2026-09-25 23:05

- **Resume match:** 25% - skipped: Candidate's NLP/GenAI and tabular ML background does not show the computer vision and embedded deep-learning experience this role requires.
- **Matched:** Python; trained production ML models; GPU/cloud training experience
- **Missing:** PyTorch/TensorFlow/Keras/JAX; computer vision; multimodal LLM training; embedded/edge inference
- **Blockers:** no computer vision background; no evidence of deep learning framework (PyTorch/TF) work
...
* Strong engineering experience with proficiency in Python.
...
**We only consider applicants who are currently based in, or willing to relocate to, London or Amsterdam. We have flexible working hours and work together from our offices on at least 2 fixed days per week.****What We Offer**
